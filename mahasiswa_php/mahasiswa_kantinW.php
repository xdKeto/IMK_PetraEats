  ...
  <body>
    ...
    <div class="container mb-5" style="margin-top: 10rem">
      ...
      <div class="row d-flex justify-content-between">
        ...
        <div class="nama-kantin col-lg-10 col-12 fw-bold">Kantin W</div>
        <div class="col-12 fs-4 fw-bold d-flex justify-content-center">Silahkan Pilih Toko:</div>
      </div>
      <!-- Button and Title -->

      <!-- Kantin -->
      <div class="row mt-1 d-flex justify-content-sm-start justify-content-center ps-lg-2">
          ...
          <div class="card shadow rounded-3" style="width: 20rem">
            <div class="container mt-2">
              <div class="image-container mt-1">
                <img src="../resource/assets/assets_lama/kantin/toko/kantinW1.jpg" class="card-img-top rounded-2" alt="Kantin Q" />
              </div>
            </div>
            <div class="card-body">
              <p class="card-text d-flex justify-content-center fs-2 fw-bold">Kedai Hong</p>
            </div>
          </div>
        </a>
        ...
        <a href="#" class="col-lg-3 col-sm-6 col-12 d-flex justify-content-center mt-lg-3 mt-5">
          <div class="card shadow rounded-3" style="width: 20rem">
            <div class="container mt-2">
              <div class="image-container mt-1">
                <img src="../resource/assets/assets_lama/kantin/toko/kantinW2.jpg" class="card-img-top rounded-2" alt="Kantin P" />
              </div>
            </div>
            <div class="card-body">
              <p class="card-text d-flex justify-content-center fs-2 fw-bold">Mie 55</p>
            </div>
          </div>
        </a>
        ...
        <a href="#" class="col-lg-3 col-sm-6 col-12 d-flex justify-content-center mt-lg-3 mt-5">
          <div class="card shadow rounded-3" style="width: 20rem">
            <div class="container mt-2">
              <div class="image-container mt-1">
                <img src="../resource/assets/assets_lama/kantin/toko/kantinW3.jpg" class="card-img-top rounded-2" alt="Kantin W" />
              </div>
            </div>
            <div class="card-body">
              <p class="card-text d-flex justify-content-center fs-2 fw-bold">Ayam Bakar Pinarak</p>
            </div>
          </div>
        </a>
        ...
        <a href="#" class="col-lg-3 col-sm-6 col-12 d-flex justify-content-center mt-lg-3 mt-5">
          <div class="card shadow rounded-3" style="width: 20rem">
            <div class="container mt-2">
              <div class="image-container mt-1">
                <img src="../resource/assets/assets_lama/kantin/toko/kantinW4.png" class="card-img-top rounded-2" alt="Kantin T" />
              </div>
            </div>
            <div class="card-body">
              <p class="card-text d-flex justify-content-center fs-2 fw-bold">Pok-Pok</p>
            </div>
          </div>
        </a>
        ...
        <a href="#" class="col-lg-3 col-sm-6 col-12 d-flex justify-content-center mt-lg-3 mt-5">
          <div class="card shadow rounded-3" style="width: 20rem">
            <div class="container mt-2">
              <div class="image-container mt-1">
                <img src="../resource/assets/assets_lama/kantin/toko/kantinW5.jpg" class="card-img-top rounded-2" alt="Kantin T" />
              </div>
            </div>
            <div class="card-body">
              <p class="card-text d-flex justify-content-center fs-2 fw-bold">Chatime</p>
            </div>
          </div>
        </a>
        ...
        <a href="#" class="col-lg-3 col-sm-6 col-12 d-flex justify-content-center mt-lg-3 mt-5">
          <div class="card shadow rounded-3" style="width: 20rem">
            <div class="container mt-2">
              <div class="image-container mt-1">
                <img src="../resource/assets/assets_lama/kantin/toko/kantinW6.png" class="card-img-top rounded-2" alt="Kantin T" />
              </div>
            </div>
            <div class="card-body">
              <p class="card-text d-flex justify-content-center fs-2 fw-bold">Starbucks</p>
            </div>
          </div>
        </a>
      </div>
