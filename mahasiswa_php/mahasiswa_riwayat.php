  ...
  <body>
    ...
    <div class="container-fluid row d-flex justify-content-center mb-5" style="margin-top: 10rem">
      ...
      <div class="row col-12 d-flex justify-content-between">
        ...
        <div class="nama-section col-12 fw-bold align-items-center custom-title">Riwayat Pesanan</div>
      </div>
      <!-- Button and Title -->

      <div class="container col-10 shadow row d-flex align-items-center justify-content-center rounded-4 shadow mt-4 pb-5 ms-1 gap-3" style="background-color: #f2f8f9">
    ...
    <!-- JavaScript -->
    <script type="text/javascript" src="../resource/js/mahasiswa_keranjang.js"></script>
