...
<body>
      ...
      <div class="col-lg-6 col-12">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav col-12 row d-flex align-items-center ms-sm-0 ms-2">
            ...
            <li class="nav-item col-lg-4 col-3 align-items-center d-flex justify-content-center mt-lg-0 mt-4 shake">
              <a href="mahasiswa_keranjang2.php" class="navbar-brand nav-link mb-0 fs-5 position-relative rounded" style="font-family: var(--font-family-1);" id="navitem-keranjang">
  ...
  <div class="container mb-5" style="margin-top: 10rem">
    ...
    <div class="row d-flex justify-content-between">
      <a class="btn btn-danger back-button col-lg-2 col-12 fw-bold ms-3 mt-1 me-auto" href="mahasiswa_kantinP.php">Back</a>
      <div class="nama-toko col-lg-10 col-12 fw-bold text-center">Kantin P<br>Depot Kita</div>
    ...
    <div class="row mt-5 d-flex justify-content-center ps-lg-2 gap-sm-0 gap-4">
      <div class="col-lg-6 col-xl-4 col-12">
        <div class="m-3 bg-light rounded-3 shadow d-flex justify-content-start justify-content-md-center">
          <div class="col-6 p-2">
            <img src="..\..\resource\assets\assets_lama\foods\depotkita1.jpg" style="max-width: 12rem" class="card-img-top rounded-2 mt-4" />
          </div>
          <div class="col-6 mt-4 pb-3">
            <div style="height: 12rem">
              <h4 class="">Nasi Ayam Kremes</h4>
              <p class="">Nasi ayam kremes dengan topping sambal</p>
              <p class="">Rp. 25.000</p>
            </div>
      ...
      <div class="col-lg-6 col-xl-4 col-12">
        <div class="m-3 bg-light rounded-3 shadow d-flex justify-content-start justify-content-md-center">
          <div class="col-6 p-2">
            <img src="..\..\resource\assets\assets_lama\foods\depotkita5.jpg" style="max-width: 12rem" class="card-img-top rounded-2 mt-4" />
          </div>
          <div class="col-6 mt-4 pb-3">
            <div style="height: 12rem">
              <h4 class="">Ayam Geprek</h4>
              <p class="">Ayam geprek dengan sambal pedas</p>
              <p class="">Rp. 25.000</p>
            </div>
            <div class="row d-flex justify-content-start align-items-center" style="padding-left: 12px; padding-right: 12px">
              <button class="btn btn-sm btn-custom col-4 fw-bold btn-minus" data-id="1" style="width: 3rem">-</button>
      ...
      <div class="col-lg-6 col-xl-4 col-12">
        <div class="m-3 bg-light rounded-3 shadow d-flex justify-content-start justify-content-md-center">
          <div class="col-6 p-2">
            <img src="..\..\resource\assets\assets_lama\foods\depotkita3.jpg" style="max-width: 12rem" class="card-img-top rounded-2 mt-4" />
          </div>
          <div class="col-6 mt-4 pb-3">
            <div style="height: 12rem">
              <h4 class="">Nasi ayam</h4>
              <p class="">Nasi ayam goreng tepung dengan saos asam manis</p>
              <p class="">Rp. 25.000</p>
            </div>
      ...
      <div class="col-lg-6 col-xl-4 col-12">
        <div class="m-3 bg-light rounded-3 shadow d-flex justify-content-start justify-content-md-center">
          <div class="col-6 p-2">
            <img src="..\..\resource\assets\assets_lama\foods\depotkita4.jpg" style="max-width: 12rem" class="card-img-top rounded-2 mt-4" />
          </div>
          <div class="col-6 mt-4 pb-3">
            <div style="height: 12rem">
              <h4 class="">Nasi Campur</h4>
              <p class="">Nasi, mie, sayur, ayam, krupuk</p>
              <p class="">Rp. 27.000</p>
            </div>
      ...
      <div class="col-lg-6 col-xl-4 col-12">
        <div class="m-3 bg-light rounded-3 shadow d-flex justify-content-start justify-content-md-center">
          <div class="col-6 p-2">
            <img src="..\..\resource\assets\assets_lama\foods\depotkita6.jpg" style="max-width: 12rem" class="card-img-top rounded-2 mt-4" />
          </div>
          <div class="col-6 mt-4 pb-3">
            <div style="height: 12rem">
              <h4 class="">Es Kelapa</h4>
              <p class="">Es kelapa dengan campuran sirup</p>
              <p class="">Rp. 14.000</p>
            </div>
      ...
      <div class="col-lg-6 col-xl-4 col-12">
        <div class="m-3 bg-light rounded-3 shadow d-flex justify-content-start justify-content-md-center">
          <div class="col-6 p-2">
            <img src="..\..\resource\assets\assets_lama\foods\sotoayamjago8.jpg" style="max-width: 12rem" class="card-img-top rounded-2 mt-4" />
          </div>
          <div class="col-6 mt-4 pb-3">
            <div style="height: 12rem">
              <h4 class="">Es Teh</h4>
              <p class="">teh manis atau tawar</p>
              <p class="">Rp. 5.000</p>
            </div>
            <div class="row d-flex justify-content-start align-items-center" style="padding-left: 12px; padding-right: 12px">
              <button class="btn btn-sm btn-custom col-4 fw-bold btn-minus" data-id="1" style="width: 3rem">-</button>
  ...
  <div class="floating-button">
    <a id="cekKeranjang" class="btn btn-keranjang fw-bold" href="mahasiswa_keranjang2.php">
  ...
  <form id="dataForm" action="mahasiswa_keranjang2.php" method="POST">
  ...
  <script type="text/javascript" src="../../resource/js/navbar2.js"></script>
