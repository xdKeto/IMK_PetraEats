        ...
        <div class="container shadow row d-flex align-items-center justify-content-center rounded-4 shadow mt-4 pb-5 ms-1 gap-3" style="background-color: #f2f8f9">
            ...
            <div class="col-12 row border border-3 rounded d-flex justify-content-center bg-light">
                <div class="col-4 d-flex align-items-center mb-4 justify-content-center">
                    <img src="..\..\resource\assets\assets_lama\foods\depotkita5.jpg" style="max-width: 12rem" class="card-img-top rounded-2 mt-4 border border-black" />
                </div>
                <div class="col-4 d-flex align-items-center justify-content-start custom-title-card">Ayam geprek</div>
            ...
            <div class="col-12 row border border-3 rounded d-flex justify-content-center bg-light">
                <div class="col-4 d-flex align-items-center mb-4 justify-content-center">
                    <img src="..\..\resource\assets\assets_lama\foods\sotoayamjago8.jpg" style="max-width: 12rem" class="card-img-top rounded-2 mt-4 border border-black" />
                </div>
                <div class="col-4 d-flex align-items-center justify-content-start custom-title-card">Es teh</div>
                <div class="col-md-4 col-12 row d-flex align-items-center justify-content-center">
                    <div class="col-12 row d-flex align-items-end justify-content-center">
                        <div class="col-12 d-flex align-items-end justify-content-center custom-price-card">Rp. 10.000</div>
                        <div class="col-12 row d-flex align-items-center justify-content-center mt-2 ms-sm-0 mb-2">
                            <button class="btn btn-sm btn-custom col-3 fw-bold btn-minus" data-id="1" style="width: 2rem">-</button>
            ...
            <div class="col-12 row d-flex justify-content-sm-end justify-content-center">
                ...
                <div class="col-6 d-flex align-items-center justify-content-start ps-4 custom-price-card fw-bold">Rp. 60.000</div>
            </div>
            ...
            $("#bayarBtn").on("click", function() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        setTimeout(function() {
                            window.location = "../mahasiswa_php/mahasiswa_bayar2.php";
                        }, 300);
                    }
                });
            });
