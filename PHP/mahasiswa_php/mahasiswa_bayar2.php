  ...
  <div class="container-fluid row d-flex justify-content-center mb-5" style="margin-top: 10rem">
    ...
    <div class="container col-8 shadow row bg-light d-flex align-items-center justify-content-center rounded-4 mt-4 pb-5 ms-1">
      ...
      <div class="col-12 row d-flex justify-content-center mb-5 pb-5 border border-3">
        ...
        <div class="col-12 mt-4 d-flex justify-content-center align-items-center fw-bold custom-va">
          VA : <span id="vaNumber">0829123891238859</span>
          <button class="btn btn-outline-secondary btn-sm ms-2" onclick="copyToClipboard()">Copy</button>
        </div>
      </div>
  ...
  <script>
    function copyToClipboard() {
      ...
      Swal.fire({
        icon: 'success',
        title: 'Copied!',
        text: 'VA number has been copied to clipboard.'
      });
    }
