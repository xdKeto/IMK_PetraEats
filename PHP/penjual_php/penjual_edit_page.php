                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav col-12 row d-flex justify-content-end align-items-center ms-sm-0 ms-2">
                        <li class="nav-item col-2 align-items-center d-flex justify-content-center mt-lg-0 mt-4">
                            <a href="penjual_home_page.php" class="navbar-brand nav-link mb-0 fs-5" style="font-family: var(--font-family-1)" id="navitem"><i class="fa fa-history"></i> Home</a>
                        </li>
                        <li class="nav-item col-2 align-items-center d-flex justify-content-center mt-lg-0 mt-4">
                        ...
                        <li class="nav-item col-2 align-items-center d-flex justify-content-center mt-lg-0 mt-4">
                            <a href="#" class="navbar-brand nav-link mb-0 fs-5 position-relative bg-light rounded rounded-3 ps-3 pe-3 text-dark" style="font-family: var(--font-family-1)"><i class="fa fa-pencil" aria-hidden="true"></i> Edit
                            </a>
                        </li>
                        <li class="nav-item col-2 align-items-center d-flex justify-content-center mt-lg-0 mt-4">
